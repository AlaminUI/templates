...
// <!-- PopUp Window -->
$(document).ready(function(){var popupStatus = 0;$('body').append('<div id="fade"></div>');$('body').append('<div id="popupblock" class="centerblock"></div>'); $('#popupblock').append('<center><h1>Website Layout Proof</h1></center>');$('#popupblock').append('<h2>These pages will be created once you approve this design layout.</h2>');$('#popupblock').append('<p>This page will determine the design structure of your website.</p>');$('#popupblock').append('<p>Please email us to let us know of any design changes that you would like to make before moving forward with your new website.</p>');$('#popupblock').append('<a href="#link" class="close">Close Window</a>');$('a[href^=#link]').click(function(){
